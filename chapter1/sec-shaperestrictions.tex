...
%We start by giving the necessary background and definitions in~\cref{sec:preliminaries}, before turning to our main result, the proof of~\cref{theo:main:testing} (our general testing algorithm) in~\cref{sec:algorithm}. 

We now turn to proving converses to our positive results -- namely, providing a general framework to establish distribution testing lower bounds, which -- once instantiated -- will allow us to easily show that many of the upper bounds we obtain cannot be significantly improved upon. 
